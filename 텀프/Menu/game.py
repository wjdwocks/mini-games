...
class Game():
    def __init__(self):
        ...
        self.UP_KEY, self.DOWN_KEY, self.START_KEY, self.BACK_KEY, self.W_KEY, self.A_KEY, self.S_KEY, self.D_KEY, self.ESC = False, False, False, False, False, False, False, False, False
    ...
    def escape_poo(self):
        ...
        ### 플레이어 캐릭터 구현.
        # 사용할 사진.
        img_character_r = pygame.image.load(r'image\character_walk_r_1.svg') # 추가.
        img_character_l = pygame.image.load(r'image\character_walk_l_1.svg') # 추가.
        # 시작 그림.
        img_character = img_character_r 
        # 플레이어 체력
        my_hp = 3
        ...
        while play:
            ...
            if poo_time == rand_time:
                rand_time = random.randrange(20, 50)
                poo_time = 0
            ...
            if len(poos):
                for itr, poo in enumerate(poos): # poo는 x,y좌표를 가짐.
                    ...
                    if rect_poos[itr].colliderect(character_rect):
                        poos.remove(poo)
                        ...
                        # img_character_r = ...
                        # img_character_l = ...
                    if poo[1] > self.DISPLAY_H: # 화면 밑으로 내려가면 없애버림.
