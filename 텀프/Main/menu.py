...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Made by JaeChan Jeong', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 30 )
            self.game.draw_text('copy right of Font : SANGSANGTOKKI', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 70 )
            self.game.draw_text('copy right of Picture of Poo : Flaticon -> Pixel perfect', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 110 )
            self.game.draw_text('copy right of space game character : scratch', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 150 )
            self.game.draw_text('copy right of Poo game Character : urbanbrush', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 190 )
            self.game.draw_text('copy right of Poo game Tissue : flacticon of Freepik.', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 230 )
            self.game.draw_text('copy right of MouseGame_Win Image : Unknown(Japanese scary pictures)', 30, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 + 270 )
