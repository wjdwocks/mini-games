...
class Game():
    def __init__(self):
        ...
        self.font_name = r'텀프\SSAnt1family\SSAntRegular.ttf' # 폰트 저작권 : 상상토끼.
    ...
    def SpaceGame1p(self):
        ...
        ### 이미지 로드
        # 배경
        img_bg = pygame.image.load(r"텀프\image\Moon.png")

        ### 캐릭터 이미지 로드
        # img_character_r = pygame.image.load(r"우주게임\image\character_walk_r_1.svg")
        img_character_r = pygame.image.load(r"텀프\image\character_walk_r_1.svg")
        img_character_l = pygame.image.load(r"텀프\image\character_walk_l_1.svg")
        # img_character_death = pygame.image.load(r"")
        # 플레이어 캐릭터
        img_character = img_character_r
        # 적 캐릭터
        img_enemy = pygame.image.load(r"텀프\image\enemy.svg")
        ...
        # 총알
        img_bullet_my = pygame.image.load(r"텀프\image\crystal-b.svg")
        img_bullet_enemy = pygame.image.load(r"텀프\image\Lightning.svg")
    ...
    def SpaceGame2p(self):
        ...
        img_1p_r = pygame.image.load(r"텀프\image\character_walk_r_1.svg")
        img_1p_l = pygame.image.load(r"텀프\image\character_walk_l_1.svg")
        # img_character_death = pygame.image.load(r"")
        img_1p = img_1p_r
        ...
        # 적
        img_2p = pygame.image.load(r"텀프\image\enemy.svg")
        ...
        # 총알
        img_bullet_1p = pygame.image.load(r"텀프\image\crystal-b.svg")
        img_bullet_2p = pygame.image.load(r"텀프\image\Lightning.svg")
    ...
    def escape_poo(self):
        ...
        img_character_rlist = [pygame.image.load(rf'텀프\image\poo_character_r_{i}.png') for i in range(1, 4, 1)]
        img_character_llist = [pygame.image.load(rf'텀프\image\poo_character_l_{i}.png') for i in range(1, 4, 1)]
        ...
        ### 휴지 구현
        img_tissue = pygame.image.load(rf'텀프\image\휴지.png')
        tissues = []
        rect_tissue = []
        ...
        ### 똥 구현.
        img_poo = pygame.image.load(r'텀프\image\poo_img.png') # 
    ...
    def mouseGame(self):
        ...
        while playing:
            ...
            if win: # 마지막에 도달한다면 성공조건
                ...
                pygame.time.delay(1000)
                win_img = pygame.image.load(r'텀프\image\mouse_win.jpg')
