...
![mouseStart](https://github.com/wjdwocks/mini-games/assets/144427497/31928401-0db2-49d3-bcba-490254c1b956)<br/>

색이 있는 화면을 넘어가게 되면 GAME OVER문구가 뜨고, 3초 뒤 메뉴화면으로 돌아가게 된다.
만약 시작 지점(좌측 하단) -> 종료 지점(중앙 상단)까지 이동하게 되면, YOU WIN문구가 뜨고, 재미있는 일이 일어나게 됩니다.
